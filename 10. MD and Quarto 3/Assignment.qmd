...
import pandas as pd
import plotly
s1=pd.read_csv('/Users/husnainmustafa/Documents/GitHub/RRcourse2024/Data/got/season_1.csv')
```
...
# Assuming s1 is your pandas DataFrame
# Replace 'viewers' with the actual column name containing viewers data
# Assuming 'viewers' is the column name for 1st day TV viewers in the US (millions)

# Create a line plot
fig = go.Figure()

fig.add_trace(go.Scatter(x=s1.index, y=s1['viewers'],
                    mode='lines',
                    name='Viewers',
                    line=dict(color='red', width=5)))

# Update layout
fig.update_layout(title='1st day TV viewers in the US (millions)',
                  xaxis_title='Episode number',
                  yaxis_title='1st day TV viewers in the US (millions)')
